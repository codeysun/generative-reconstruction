...
def eval_whole_dataset(pred_folder, merge_parts=False):
    print(pred_folder)
    meta = json.load(open("/home/codeysun/git/data/PartObjaverse-Tiny/PartObjaverse-Tiny_semantic.json", "r"))
    ...
    for cat in categories:
        ...
        for shape_id in meta[cat].keys():
            ...
            try:
                ...
                fname_clustering = f'/home/codeysun/git/PartSLIP/PartSLIP-main/eval/partobjtiny/instance_preds/{shape_id}.npy'
                pred_label = np.load(fname_clustering)
                all_pred_labels.append(np.squeeze(pred_label))  
            ...
            gt_labels_path = "/home/codeysun/git/data/PartObjaverse-Tiny/PartObjaverse-Tiny_instance_gt"
    ...
    print("Mean per object")
    print(np.mean(overall_mious), len(overall_mious))

                
if __name__ == "__main__":
    eval_whole_dataset("exp_results/clustering/partobjtiny")
